function addToGallery(galleryId, infoJsonURL, link, width, height) {
    ...
    retrieveInfoJson(infoJsonURL, function (infoJson) {
        ...
        ul.append(addLink("info.json", infoJsonURL));
        ul.append(addLink("OpenSeaDragon", "https://iiif.gdmrdigital.com/openseadragon/index.html?image=" + infoJsonURL));
        ul.append(addLink("UCD Cropper", "https://jbhoward-dublin.github.io/IIIF-imageManipulation/index.html?imageID=" + infoJsonURL.replace("/info.json", "")));
*/
